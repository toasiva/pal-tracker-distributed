DROP DATABASE tracker_allocations_dev;
DROP DATABASE tracker_backlog_dev;
DROP DATABASE tracker_registration_dev;
DROP DATABASE tracker_timesheets_dev;
DROP DATABASE tracker_allocations_test;
DROP DATABASE tracker_backlog_test;
DROP DATABASE tracker_registration_test;
DROP DATABASE tracker_timesheets_test;
